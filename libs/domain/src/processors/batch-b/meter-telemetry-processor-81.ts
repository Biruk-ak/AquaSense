 ...
 * Batch processor 81 — meter telemetry & DMA analysis
 * @copyright Biruk-ak
 */

export type TelemetryPoint81 = {
  meterId: string;
  timestamp: string;
  flowLpm: number;
  pressureBar: number;
...
export class MeterTelemetryProcessor81 {

  static analyzeWindow0(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw0(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
  ...
  static analyzeWindow1(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw1(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow2(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw2(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow3(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw3(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow4(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw4(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow5(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw5(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow6(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw6(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow7(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw7(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow8(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw8(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow9(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw9(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow10(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw10(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow11(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw11(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow12(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw12(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow13(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw13(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow14(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw14(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow15(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw15(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow16(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw16(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow17(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw17(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow18(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw18(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow19(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw19(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow20(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw20(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow21(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw21(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow22(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw22(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow23(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw23(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow24(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw24(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow25(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw25(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow26(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw26(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow27(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw27(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow28(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw28(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow29(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw29(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow30(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw30(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow31(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw31(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow32(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw32(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow33(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw33(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow34(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw34(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow35(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw35(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow36(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw36(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow37(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw37(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow38(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw38(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow39(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw39(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow40(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw40(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow41(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw41(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow42(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw42(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow43(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw43(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
  ...
  static analyzeWindow44(points: TelemetryPoint81[]): {
    averageFlow: number;
    peakFlow: number;
    minPressure: number;
    anomalyScore: number;
  ...
  static estimateNrw44(snap: DmaSnapshot81): {
    nrwM3: number;
    nrwPct: number;
    nightPerConnection: number;
    riskBand: 'low' | 'medium' | 'high';
